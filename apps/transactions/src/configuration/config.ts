...
export default (): AppConfiguration => ({
  ...
  brokerSettings: createRabbitContext(process.env.QUEUE_NAME || 'transactions_queue'),
  userBrokerSettings: createRabbitContext(process.env.USERS_QUEUE || 'users_queue'),
});
